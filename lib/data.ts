...
The substantial cylindrical marble legs echo the shape of the tabletop, creating a balanced and architectural silhouette. Its understated form and natural stone finish make it an elegant centrepiece for contemporary, modern, and luxury interiors.`,
  ...
  },
  {
  ...
  },
   {
    ...
    collection: "side-tables",
    price: "Request Quote",
    image: "/images/sidetable03main.jpeg",
    images: [
    ...
    collection: "side-tables",
    price: "Request Quote",
    image: "/images/sidetable04main.jpeg",
    images: [
      "/images/sidetable04main.jpeg",
      "/images/sidetable04angle1.jpeg",
    ],
    description: "A refined oval dining table crafted from premium Makrana white marble, featuring a softly curved tabletop with elegant rounded edges and a sculptural three-pillar base. The natural grey veining flows beautifully across the marble, enhancing its organic character and luxurious appeal. Its balanced proportions and contemporary silhouette make it a striking centerpiece for sophisticated dining spaces, modern residences, luxury restaurants, and hospitality interiors.",
    dimensions: "45*25*45",
    material: "Natural Marble",
    marbleType: "Makrana Marble",
    finish: "Polished",
    ...
    collection: "side-tables",
    price: "Request Quote",
    image: "/images/sidetable05main.jpeg",
    images: [
      "/images/sidetable05main.jpeg",
      "/images/sidetable05angle1.jpeg",
      "/images/sidetable05angle2.jpeg",
    ],
    description: "A distinctive round coffee table crafted from premium Makrana white marble, featuring a sculptural circular tabletop with a unique split-ring design surrounding a raised central element. The seamless cylindrical pedestal base complements the organic curves creating a bold yet refined architectural form. Subtle natural grey veining runs throughout the warm-white marble, adding depth and character while maintaining a sophisticated minimalist aesthetic. Perfect for contemporary living rooms, luxury residences, boutique hotels, and high-end interior spaces",
    dimensions: "47*45*50",
    material: "Natural Marble",
    marbleType: "Makrana Marble",
    finish: "Polished",
  ...
  },
   {
    ...
    collection: "side-tables",
    price: "Request Quote",
    image: "/images/sidetable06main.jpeg",
    images: [
      "/images/sidetable06main.jpeg",
      "/images/sidetable06angle1.jpeg",
    ],
    description: "A contemporary sculptural coffee table crafted from premium Makrana white marble. It features a distinctive round tabletop with a subtle split-ring detail and a broad, sturdy tapered pedestal base, giving the piece a grounded and substantial presence. The warm-white marble is enhanced by delicate natural grey veining, while the softly rounded edges create a refined, seamless look. Its bold yet minimalist silhouette makes it an elegant statement piece for modern living rooms, lounges, luxury residences, and hospitality interiors.",
    dimensions: "54*45*40",
    material: "Natural Marble",
    marbleType: "Makrana Marble",
    finish: "Polished",
  ...
  },
  {
   ...
   {
    id: "02",
    slug: "console-table02",
    name: "Marble Console Table",
    collection: "console-tables",
    price: "Request Quote",
    image: "/images/consoletable02main.jpeg",
    images: [
      "/images/consoletable02main.jpeg",
      "/images/consoletable02angle1.jpeg",
      "/images/consoletable02angle2.jpeg",
    ],
        description: "A sophisticated Makrana white marble console table featuring a sleek, elongated rectangular top with softly rounded edges and a substantial sculptural base. The distinctive U-shaped support design creates an open, architectural silhouette while maintaining a strong, grounded presence. Subtle natural grey veining across the marble adds depth and character, beautifully complementing its warm-white tone. Its minimalist form and monolithic construction make it an elegant statement piece for modern entryways, living rooms, hallways, and luxury interiors.",
    dimensions: "160*40*80",
    material: "Natural Marble",
    marbleType: "Makrana Marble",
    finish: "Polished",
    weight: "250 kg approx",
  ...
  {
    id: "03",
    slug: "console-table03",
    name: "Marble Console Table",
    collection: "console-tables",
    price: "Request Quote",
    image: "/images/consoletable03main.jpeg",
    images: [
      "/images/consoletable03main.jpeg",
      "/images/consoletable03angle1.jpeg",
    ],
        description: "A sophisticated Makrana white marble console table featuring a sleek, elongated rectangular top with softly rounded edges and a substantial sculptural base. The distinctive U-shaped support design creates an open, architectural silhouette while maintaining a strong, grounded presence. Subtle natural grey veining across the marble adds depth and character, beautifully complementing its warm-white tone. Its minimalist form and monolithic construction make it an elegant statement piece for modern entryways, living rooms, hallways, and luxury interiors.",
    dimensions: "30*130*76",
    material: "Natural Marble",
    marbleType: "Makrana Marble",
    finish: "Polished",
    weight: "200 kg approx",
