      ...
      <div className="mx-auto grid max-w-8xl gap-12 px-6 py-16 md:grid-cols-4 md:px-8 lg:px-12">
        <div className="md:col-span-1">
          ...
          <div className="mt-6 flex gap-4 text-charcoal/60 dark:text-ivory/60">
            <a href="https://instagram.com/surface_s_" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-gold"><Instagram className="h-5 w-5" strokeWidth={1.5} /></a>
