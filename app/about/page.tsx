...
export const metadata: Metadata = {
  title: "About Us | Surface Studio",
  description:
    "Surface Studio creates collectible furniture from nature's exquisite stones. Every piece is defined by rare material, redefined form and meticulous craftsmanship.",
};

const makingOfAPiece = [
  {
    title: "THE SLAB",
    event: "We begin with a stone chosen for its unique movement, veining and character.",
  },
  {
    title: "THE VISION",
    event: "The natural pattern inspires the shape, proportions and direction of the design.",
  },
  {
    title: "THE FORM",
    event: "The slab is precisely cut and sculpted into a distinctive silhouette.",
  },
  {
    title: "THE FINISH",
    event: "Edges, surfaces and details are refined by hand to reveal the stone at its best.",
  },
  {
    title: "THE PIECE",
    event: "A raw slab becomes a one-of-a-kind object designed to live beautifully for years.",
  },
];
